 ...
 * the following {@link java.io.File} attributes at a point in time.
 * <ul>
 *   <li>File Name (see {@link java.io.File#getName()})</li>
 *   <li>Exists - whether the file exists or not (see {@link java.io.File#exists()})</li>
 *   <li>Directory - whether the file is a directory or not (see {@link java.io.File#isDirectory()})</li>
 *   <li>Last Modified Date/Time (see {@link java.io.File#lastModified()})</li>
 *   <li>Length (see {@link java.io.File#length()}) - directories treated as zero</li>
 *   <li>Children - contents of a directory (see {@link java.io.File#listFiles(java.io.FileFilter)})</li>
 * </ul>
 * <p>
 * <h3>Custom Implementations</h3>
 * If the state of additional {@link java.io.File} attributes is required then create a custom
 * {@link com.ohyea777.plundercraft.libs.org.apache.commons.io.monitor.FileEntry} with properties for those attributes. Override the
 * {@link #newChildInstance(java.io.File)} to return a new instance of the appropriate type.
 * You may also want to override the {@link #refresh(java.io.File)} method.
