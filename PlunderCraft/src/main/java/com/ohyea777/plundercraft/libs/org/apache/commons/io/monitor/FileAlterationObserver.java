 ...
 */
package com.ohyea777.plundercraft.libs.org.apache.commons.io.monitor;
...
import com.ohyea777.plundercraft.libs.org.apache.commons.io.IOCase;
import com.ohyea777.plundercraft.libs.org.apache.commons.io.comparator.NameFileComparator;
 ...
 * <ul>
 *   <li>Create {@link com.ohyea777.plundercraft.libs.org.apache.commons.io.monitor.FileAlterationListener} implementation(s) that process
 *      the file/directory create, change and delete events</li>
 *   <li>Register the listener(s) with a {@link com.ohyea777.plundercraft.libs.org.apache.commons.io.monitor.FileAlterationObserver} for
 *       the appropriate directory.</li>
 *   <li>Either register the observer(s) with a {@link com.ohyea777.plundercraft.libs.org.apache.commons.io.monitor.FileAlterationMonitor} or
 *       run manually.</li>
 * </ul>
 *
 * <h2>Basic Usage</h2>
 * Create a {@link com.ohyea777.plundercraft.libs.org.apache.commons.io.monitor.FileAlterationObserver} for the directory and register the listeners:
 * <pre>
 ...
 *      observer.finish();
 * </pre>
 * Alternatively, register the oberver(s) with a {@link com.ohyea777.plundercraft.libs.org.apache.commons.io.monitor.FileAlterationMonitor},
 ...
 * by using {@link java.io.FileFilter}s to observe only the files and/or directories
 ...
 * in a root directory called "src" you could set up a {@link com.ohyea777.plundercraft.libs.org.apache.commons.io.monitor.FileAlterationObserver} in the following
 * way:
 * <pre>
 *      // Create a FileFilter
 ...
 *
 * <h2>FileEntry</h2>
 * {@link com.ohyea777.plundercraft.libs.org.apache.commons.io.monitor.FileEntry} represents the state of a file or directory, capturing
 * {@link java.io.File} attributes at a point in time. Custom implementations of
 * {@link com.ohyea777.plundercraft.libs.org.apache.commons.io.monitor.FileEntry} can be used to capture additional properties that the
 * basic implementation does not support. The {@link com.ohyea777.plundercraft.libs.org.apache.commons.io.monitor.FileEntry#refresh(java.io.File)}
 * method is used to determine if a file or directory has changed since the last
 * check and stores the current state of the {@link java.io.File}'s properties.
 *
 * @see com.ohyea777.plundercraft.libs.org.apache.commons.io.monitor.FileAlterationListener
 * @see com.ohyea777.plundercraft.libs.org.apache.commons.io.monitor.FileAlterationMonitor
