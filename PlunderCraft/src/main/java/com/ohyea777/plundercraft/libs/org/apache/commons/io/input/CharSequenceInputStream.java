...
/**
 * {@link java.io.InputStream} implementation that can read from String, StringBuffer,
...
public class CharSequenceInputStream extends InputStream {
    ...
    /**
     * Constructor, calls {@link #CharSequenceInputStream(CharSequence, java.nio.charset.Charset, int)}.
     * 
     * @param s the input character sequence
     * @param charset the character set name to use
     * @param bufferSize the buffer size to use.
