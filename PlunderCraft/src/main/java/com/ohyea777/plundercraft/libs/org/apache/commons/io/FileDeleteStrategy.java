...
public class FileDeleteStrategy {
     ...
     * <p>
     * Subclass writers should override {@link #doDelete(java.io.File)}, not this method.
     *
     ...
     * @throws java.io.IOException if an error occurs during file deletion
     */
     ...
     * when deletion fails. The {@link #delete(java.io.File)} and {@link #deleteQuietly(java.io.File)}
     * methods will handle either response appropriately.
     * A check has been made to ensure that the file will exist.
     * <p>
     * This implementation uses {@link java.io.File#delete()}.
     *
