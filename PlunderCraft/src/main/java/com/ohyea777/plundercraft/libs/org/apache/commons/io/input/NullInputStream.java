...
/**
 * A functional, light weight {@link java.io.InputStream} that emulates
 * a stream of a specified size.
 * <p>
 * This implementation provides a light weight
 * object for testing with an {@link java.io.InputStream}
 * where the contents don't matter.
 * <p>
 * One use case would be for testing the handling of
 * large {@link java.io.InputStream} as it can emulate that
...
public class NullInputStream extends InputStream {
    ...
    /**
     * Create an {@link java.io.InputStream} that emulates a specified size
    ...
    /**
     * Create an {@link java.io.InputStream} that emulates a specified
     ...
     * will throw an {@link java.io.EOFException} or return -1 when the
    ...
    /**
     * Return the size this {@link java.io.InputStream} emulates.
     *
     ...
     * @throws java.io.EOFException if the end of file is reached and
     * <code>throwEofException</code> is set to {@code true}.
     * @throws java.io.IOException if trying to read past the end of file.
     */
    @Override
     ...
     *
     * @throws UnsupportedOperationException if mark is not supported.
     * @throws java.io.IOException If no position has been marked
     ...
     * set to {@code false}
     * @throws java.io.EOFException if <code>throwEofException</code> is set
     * to {@code true}.
     */
