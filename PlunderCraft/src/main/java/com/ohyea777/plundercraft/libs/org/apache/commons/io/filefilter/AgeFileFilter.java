 ...
 * @see FileFilterUtils#ageFileFilter(java.util.Date)
 * @see FileFilterUtils#ageFileFilter(java.io.File)
 * @see FileFilterUtils#ageFileFilter(long)
 * @see FileFilterUtils#ageFileFilter(java.util.Date, boolean)
 * @see FileFilterUtils#ageFileFilter(java.io.File, boolean)
